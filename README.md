...
Уровень: высокий
Проблема:
Склады не хотят внедрять новые системы (страх изменений, обучение сотрудников).
...
Уровень: высокий
Проблема:
неправильные локации, ошибки в заказах -> система даёт неверные маршруты
...
Уровень: средний
Проблема:
баги в маршрутах, сканировании или задачах
...
Уровень: высокий
Проблема:
сотрудники игнорируют систему -> работают “по-старому”
...
Уровень: средний
Проблема:
существуют крупные решения (SAP, WMS)
...
Уровень: средний
Проблема:
при росте пользователей система может тормозить
